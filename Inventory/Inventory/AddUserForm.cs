...
namespace Inventory
{
    public partial class AddUserForm : Form
    {
        ...
        {
            if (!Util.CheckEmptyString(UsernameTextbox.Text) || !Util.CheckEmptyString(PasswordTextbox.Text)) 
            ...
            else
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    SqlCommand check = new SqlCommand(
                        "SELECT * FROM Account WHERE Username = @Username", conn);
                    ...
                    else
                    {
                        SqlCommand insert = new SqlCommand(
                            "INSERT INTO Account (Username, Password) VALUES (@username, @password)", conn);
