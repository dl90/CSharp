...
namespace week_05_preclass_roles.Controllers
{
    ...
    public class UserRoleController : Controller
    {
        ...
        // the requested user selected. The second drop down contains all possible roles.
        public ActionResult Create(string userName)
        {
            // Store the email address of the Identity user which is their user name.
            ...
            // a) Build a list of SelectListItem objects which have 'Value' and 'Text' properties.
            var preRoleList = roles.Select(r => new SelectListItem { Value = r.RoleName, Text = r.RoleName }).ToList();

            // b) Store the SelectListItem objects in a SelectList object with 'Value' and 'Text' properties set specifically.
            ...
            // b) Store the SelectListItem objects in a SelectList object with 'Value' and 'Text' properties set specifically.
            var preUserList = userList.Select(u => new SelectListItem { Value = u.Email, Text = u.Email }).ToList();
        ...
        public async Task<IActionResult> Create(UserRoleVM userRoleVM)
        {
            ...
            {
                var addUR = await userRoleRepo.AddUserRole(userRoleVM.Email, userRoleVM.Role);
            }
