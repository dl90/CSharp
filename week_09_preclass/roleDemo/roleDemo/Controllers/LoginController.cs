...
namespace roleDemo.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        [HttpGet]
        [Route("List")]
        // Since we have cookie authentication and Jwt authentication we must specify that we want Jwt authentication here.
        ...
        public async Task<IActionResult> OnPostAsync([FromBody] LoginVM loginVM)
        {
            ...
            {
                var result = await _signInManager.PasswordSignInAsync(loginVM.Email.ToUpper(), loginVM.Password, loginVM.RememberMe, lockoutOnFailure: true);
                if (result.Succeeded)
                {
